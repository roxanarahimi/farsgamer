    ...
    <div class="card border-0 border-start rounded-0 me-5 px-3 px-xl-5 px-3 pt-4 pb-5 me-2">
      ...
      <div v-if="this.$route.name === 'Home' || this.$route.name === 'Advertisement'" class="row">
        <div class="text-center">
          ...
          <router-link v-else to="/login" class="text-black-50 text-center mb-1 mt-3 d-block"><i
              class="bi bi-person"></i> ورود/ ثبت نام
          </router-link>
          <router-link to="/ad+">
            <btn-primary-shadow>
            ...
            <div class="">
              ...
              <div v-for="item in categories">
                ...
                <div class="sub_category d-none" :id="'sub_cat__' + item.id">
                  ...
                  <div class="d-flex text-black-50  cursor" @click="showAllCategories">
                    <i class="bi bi-arrow-right-short d-inline-block ms-3 "
                       style=" width: 21px; overflow-x: hidden;font-size: 40px"></i> <b class=""
