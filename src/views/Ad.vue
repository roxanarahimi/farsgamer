  ...
  <div class="row mt-5 pt-2">
        ...
        <div class="col-10   pb-2">
          <div class="card h-100">
            <div class="card-body px-1 py-5">
              ...
              <img src="/img/sample.jpg" style="width: 100%; height: 100%" alt="">
              <div class="bg-light" style=" position: absolute;top: 200px; left: 10px;
               font-size: 25px; width: 30px;height: 30px ;border-radius: 50%">
    ...
    <div class="col-lg-6">
      ...
      <div class="card-header d-flex">
        ...
        <div class="pe-3">
          <p class="mb-0 mt-2">مدیر دوبلاژ</p>
          <small>فروشنده احراظ هویت شده</small>
        </div>

      </div>
        <p class="fw-bold mb-0 px-3"> اکانت فورتناین از سیزن دو</p>
        <small class="px-3"> اکانت فورتناین از سیزن دو</small>
      </div>
    </div>
  </div>
</template>
